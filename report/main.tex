...
\fancypagestyle{main}{
  \fancyhf{}
  \fancyhead[L]{Estudio Hidrológico del Río Paucartambo 2025 - C.H. Yuncán}
  \fancyhead[R]{ENGIE Energía Perú S.A.A.}
  \fancyfoot[C]{\thepage}
}
...
% Paragraph spacing: separate paragraphs with a blank line in the source.
